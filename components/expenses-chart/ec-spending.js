...
function ECSpending({ days }) {
  return (
    <>
      <div id="spending" className="flex flex-col justify-between h-[421px] md:h-[511px] space-y-6 bg-ec-card-white rounded-[10px] md:rounded-[20px] p-[20px] md:p-[40px] md:pt-[28px]">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between">
            <p className="text-ec-xl md:text-ec-xxxl text-ec-brown-700 font-bold md:leading-[54px]">$478.33</p>
            <div>
